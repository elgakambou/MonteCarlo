...
double BSCall::computeU(double param1, double param2 ) {
    return(param1 - param2) * payoff(param2) * payoff(param2) * weight_plus(param2, param1);
}

double BSCall::gamma(double theGamma, int n , double beta ) {
        return  theGamma /  pow(  ( 1+ n), beta );
}
